...
(async () => {
  ...
  try {
    ...
    const result = await page.evaluate(async () => {
      ...
      return { css:css.includes('--xuan-base'), image:image.naturalWidth, baked:baked.naturalWidth, optics:typeof optics.createRenderer, touch:touch.includes('FangcunTouchMaterial'), build:app.includes('20260923-oct14-exception-fix'), mobile, fonts };
    });
